...
\begin{center}
    ...
    \textcolor{secondary}{\normalsize Data Engineer \& AI Developer }\\[6pt]
...
\projectitem{AI-based U.S. Crime Management System (Internship at CNPT Technology JSC)}{Jun 2025 -- Jul 2025}
    {DistilBERT • DeBERTa-v3 • FastAPI • NLP • Python}
    {}
    {\begin{itemize}[leftmargin=12pt,itemsep=0.5pt,parsep=0pt,topsep=0pt,after=\vspace{-4pt},label={•}]
        \item Acted as AI Team Leader during a 1-month internship at CNPT Technology JSC.
        \item Led the team in researching and proposing core features for the U.S. crime analysis system.
        \item Decided to implement two key AI tasks: information extraction and contradiction detection from testimonies.
        \item Completed the data preprocessing pipeline; currently preparing to fine-tune DistilBERT and DeBERTa-v3-large-MNLI for downstream tasks.
    \end{itemize}}
